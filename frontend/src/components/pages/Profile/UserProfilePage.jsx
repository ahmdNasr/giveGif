...
import Avatar from '@mui/material/Avatar'; import MuiSwitch from './../../common/MuiSwitch';
...
const UserProfilePage = (props) => {
    ...
    return (
        <DefaultPage title="UserProfile">
            <Avatar sx={{ width: 200, height: 200 }} alt={profileData.username} src={apiBaseUrl + "/profilePictures/" + profileData.profilePicture} />
